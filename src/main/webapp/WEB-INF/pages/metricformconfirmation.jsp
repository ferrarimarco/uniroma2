...
<head>
<title><fmt:message key="metricConfirmation.title" /></title>
...
<div class="span10">
	<h2>
		<fmt:message key='metricConfirmation.heading' />
	</h2>
	<p>
		<fmt:message key='metricConfirmation.message' />
	</p>
	<form:form commandName="metricformconfirmation" method="post" action="metricformconfirmation" id="metricformconfirmation" cssClass="well form-horizontal">
	...
	<display:table name="metricList"
		...
		id="metricList" export="true" pagesize="25">
