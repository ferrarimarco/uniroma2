		...
		masterPasswordOkButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!masterPassword.equals(masterPasswordConfirmation)){
					...
					Toast.makeText(MasterPasswordInitActivity.this, R.string.masterPasswordNotConfirmed, Toast.LENGTH_SHORT).show();
				}else{
					...
					Toast.makeText(MasterPasswordInitActivity.this, R.string.masterPasswordOkConfirmation, Toast.LENGTH_SHORT).show();
				}
